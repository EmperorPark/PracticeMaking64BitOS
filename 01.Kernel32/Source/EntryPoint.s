...
; 데이터 영역
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; 아래의 데이터들을 8 bytes에 맞춰 정렬하기 위해 추가
align 8, db 0

; GDTR의 끝을 8 bytes로 정렬하기 위해 추가
dw 0x0000
; GDTR 자료구조 정의
GDTR:
...
GDT:
    ...
    IA_32eCODEDESCRIPTOR:
        ...
        dw 0x0000   ; Base [15:0]
        db 0x00     ; Base [23:16]
        db 0x9A     ; P(Present)=0b1, DPL(Descriptor Privilege Level)=0b00, S(Discripter Type 1:Segment Des, 0:System Des)=0b1(Code Segment), Type=0x0A(Execute/Read)
