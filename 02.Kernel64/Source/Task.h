...
#define TASK_R90OFFSET          10
#define TASK_R80OFFSET          11
...
// 태스크 풀의 어드레스
#define TASK_TCBPOOLADDRESS     0x800000 // IST 영역에 이어서 태스크 풀 영역 지정
#define TASK_MAXCOUNT           1024 // 생성 할 수 있는 최대 태스크 수, 만약 태스크를 1024개 이상 생성하고 싶다면 매크로의 값 수정
