...
{
    // 리스트를 연결하는 자료구조
    LISTLINK stLink; // 다음 데이터의 어드레스를 저장하는 자료구조. 반드시 자료구조의 첫 부분에 위치함.
...
typedef struct kListManagerStruct
{
    ...
    void* pvHeader; // 첫번째 데이터의 어드레스를 저장하는 포인터
    void* pvTail; // 마지막 데이터의 어드레스를 저장하는 포인터
