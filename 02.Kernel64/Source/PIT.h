...
#define PIT_FREQUENCY       1193182 // 1.193182Mhz
#define MSTOCOUNT( x )     ( PIT_FREQUENCY * ( x ) / 1000 ) // millisecond 값을 카운터 값으로 변환하는 매크로
#define USTOCOUNT( x )     ( PIT_FREQUENCY * ( x ) / 1000000 ) // microsecond 값을 카운터 값으로 변환하는 매크로
